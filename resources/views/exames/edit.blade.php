...
@section('content')
    <div x-data="setup()" x-init="carregarDados()">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2">Editar Exame</span>
                    </div>
                </li>
            </ol>
        </nav>
...
@push('scripts')
    <script>
        function setup() {
            return {
                exameData: @json($exame),
                nome: '',
                descricao: '',
                id: '',
                async carregarDados(){
                    this.nome = this.exameData.nome;
                    this.descricao = this.exameData.descricao;
                    this.id = this.exameData.id;
                },
                async salvarExame() {
                    ...
                    try {
                        ...
                        const url = `{{ url('exames/atualizar') }}/${this.id}`;
